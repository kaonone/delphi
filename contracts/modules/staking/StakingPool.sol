...
contract StakingPool is Module, IERC900 {
     ...
     */
    function getPersonalStakeUnlockedTimestamps(address _address)
        external
        view
     ...
     */
    function getPersonalStakeActualAmounts(address _address)
        external
        view
        returns (uint256[] memory)
    {
     ...
     */
    function getPersonalStakeForAddresses(address _address)
        external
        view
        ...
        )
    {
        ...
        for (
            ...
            unlockedTimestamps[index] = stakeContract.personalStakes[i]
                .unlockedTimestamp;
    ...
    function createStake(
        ...
        stakeHolders[_address].totalStakedFor = stakeHolders[_address]
            .totalStakedFor
            .add(_amount);
        stakeHolders[_msgSender()].personalStakes.push(
            Stake(block.timestamp.add(_lockInDuration), _amount, _address)
        );
    ...
    function withdrawStake(uint256 _amount, bytes memory _data) internal {
        Stake storage personalStake = stakeHolders[_msgSender()]
            .personalStakes[stakeHolders[_msgSender()].personalStakeIndex];
        ...
        stakeHolders[personalStake.stakedFor]
            .totalStakedFor = stakeHolders[personalStake.stakedFor]
            .totalStakedFor
