...
//     function updateGlobalBuyAmount(
//         uint256 tokenId,
//         uint256 buyAmount,
//         bool isNew
//     ) private {
...
//     function updateTokenToSellBalance(
//         uint256 tokenId,
//         uint256 amount,
//         uint256 buyAmount
//     ) private {
...
//             updateRemovalPoint(tokenId, _accountOf[tokenId].buyAmount, true);
//             updateTokenToSellBalance(tokenId, amount, buyAmount);
//             updateGlobalBuyAmount(tokenId, buyAmount, true);
...
//             uint256 oldBuyAmount = _accountOf[tokenId].buyAmount;

//             updateTokenToSellBalance(tokenId, amount, buyAmount);
//             updateRemovalPoint(tokenId, oldBuyAmount, false);
//             updateGlobalBuyAmount(tokenId, buyAmount, false);
...
//             updateRemovalPoint(tokenId, _accountOf[tokenId].buyAmount, false);
