...
import "./CurveFiSwapStub_SBTC.sol";

contract CurveFiDepositStub_SBTC is Base, ICurveFiDeposit_SBTC {
    using SafeMath for uint256;
    uint256 constant EXP_SCALE = 1e18;  //Exponential scale (see Compound Exponential)
    uint256 public constant N_COINS = 3;

    CurveFiSwapStub_SBTC public curveFiSwap;
    IERC20 public token;
    ...
    function initialize(address _curveFiSwap) public initializer {
        Base.initialize();
        curveFiSwap = CurveFiSwapStub_SBTC(_curveFiSwap);
