...
contract yUSDT is ERC20, ERC20Detailed, ReentrancyGuard, Structs {
  ...
  function initialize() public initializer {
    ERC20Detailed.initialize("iearn USDT", "yUSDT", 6);
    token = address(0x24aDb40D9230BDdaF3b5b5f3428eA0B69a0aCaD7 );
    ...
    fulcrum = address(0xeE12Cf70e0C2d7701F13BaA2Dc2b4711612dA698);
    aaveToken = address(0xaa00a7D9CE6FF22bd1Cb02CdcBc4b8D6E4CEd737);
    compound = address(0x2255e6309e0e8BfA8237fca3B50518607FD7B1F2);
    dToken = 3;
    approveToken();
  }
