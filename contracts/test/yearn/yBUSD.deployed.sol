...
contract yBUSD is ERC20, ERC20Detailed, ReentrancyGuard, Structs {
  ...
  function initialize() public initializer {
    ERC20Detailed.initialize("iearn BUSD", "yBUSD", 18);
    token = address(0xc7f6b2702128E2d47A4C02ced1AC23Cef2084483);
    ...
    fulcrum = address(0x84571139040c6aA34235D983C4461dbb039bEcB0);
    aaveToken = address(0xB12620790C87482Dc5643A5B60A31877d2F00542);
    compound = address(0xF57834E136986C11875BAA440c085Cb8FADE1975 );
    dToken = 5;
    approveToken();
  }
